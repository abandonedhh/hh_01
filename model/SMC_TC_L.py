...
class SMC_TC(torch.nn.Module):
    def __init__(self, config):
        ...
        self.fc = torch.nn.Linear(config.hidden_size * 9, config.num_labels)
        ...
        self.self_attention = torch.nn.MultiheadAttention(embed_dim=config.hidden_size * 3, num_heads=1,
    ...
    def forward(self, data):
        ...
        hw = self.self_attention(tw, tw, tw)[0]  # shape[batch_size,max_length,3*hidden_size]
